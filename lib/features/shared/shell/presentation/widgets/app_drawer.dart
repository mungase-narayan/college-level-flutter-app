...
/// Port of `src/pages/<role>/components/sidebar.tsx`.
///
...
///
/// Driven entirely by [spec], so every role area gets the same drawer without a
/// second copy of it.
class AppDrawer extends StatelessWidget {
  const AppDrawer({super.key, required this.spec, required this.currentPath});
  ...
  Widget build(BuildContext context) {
    final active = spec.activeFor(currentPath);
    ...
    return Drawer(
      ...
      child: SafeArea(
        child: Column(
          ...
          children: [
            _DrawerHeader(portalLabel: spec.portalLabel),
...
/// The app-logo chip + school name / portal-label block from
/// `Mobile<Role>Sidebar`.
class _DrawerHeader extends StatelessWidget {
  const _DrawerHeader({required this.portalLabel});
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(portalLabel, style: theme.textTheme.labelSmall),
                  ],
                ),
              ),
            ],
